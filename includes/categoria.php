...
.paymentWrap .paymentBtnGroup .paymentMethod .method.cerveja {
 background-image: url("<?=$site;?>img/cerveja.png");
 background-size: 30px auto;

}

.paymentWrap .paymentBtnGroup .paymentMethod .method.churrasco {
 background-image: url("<?=$site;?>img/churrasco.png");
 background-size: 30px auto;

}

.paymentWrap .paymentBtnGroup .paymentMethod .method.frango-assado {
 background-image: url("<?=$site;?>img/frango-assado.png");
 background-size: 30px auto;

}

.paymentWrap .paymentBtnGroup .paymentMethod .method.macarrao-na-chapa {
 background-image: url("<?=$site;?>img/macarrao-na-chapa.png");
 background-size: 30px auto;
...
<b style="margin: 2px;"> 
  <label class="btn paymentMethod">
   <div class="method cerveja"></div>
   <input type="radio" class="input" name="icon_cat" value="img/cerveja.png"> 
 </label>
</b>

<b style="margin: 2px;"> 
  <label class="btn paymentMethod">
   <div class="method churrasco"></div>
   <input type="radio" class="input" name="icon_cat" value="img/churrasco.png"> 
 </label>
</b>

<b style="margin: 2px;"> 
  <label class="btn paymentMethod">
   <div class="method frango-assado"></div>
   <input type="radio" class="input" name="icon_cat" value="img/frango-assado.png"> 
 </label>
</b>

<b style="margin: 2px;"> 
  <label class="btn paymentMethod">
   <div class="method macarrao-na-chapa"></div>
   <input type="radio" class="input" name="icon_cat" value="img/macarrao-na-chapa.png"> 
 </label>
 </b>
