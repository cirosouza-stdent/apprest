      ...
      <article class="col-md-4">
        <div id="divImprimir" style="background-color: #fdfbe3;" class="boxed-md boxed-padded">
          ...
          if(!empty($desconto) && $desconto != 0):
            echo "DESCONTO: {$desconto} % (Obs: O desconto não se aplica na taxa de entrega!) \n <br />";
          endif;
          if($valor_taxa != '0.00'):
...
<div class="container">
  <div style="margin: 0 auto;align-items: center;display: flex;flex-direction: row;flex-wrap: wrap;justify-content: center;" class="row justify-content-center ">
    ...
    <div class="form-group green-border-focus">
      ...
      <center><small>Essa msg acima será enviada ao cliente pelo whatsapp.</small></center>
      <center><small><b>Veja o tutorial no final da página para ativar</b> </small></center>
      <center><small><b>o pop up do navegador para que as atualizações</b> </small></center>
      <center><small><b>de pedidos sejam entregues para os seus clientes</b> </small></center>
      <center><small><b>quando você salvar o status. Obs: Esse procedimento</b> </small></center>
      <center><small><b>é só para quem usa o a plataforma no navegador!</b></small></center>
    </div>
...
<div class="alert alert-info container margin_60">
  ...
  <p>
   ...
   <div><strong style="color: red;">COMO ATIVAR O POPUP DO NAVEGADOR GOOGLE CHROME: </div>
   <div></strong>1 - No computador, abra o Chrome.</div>
   <div></strong>2 - No canto superior direito, clique nos 3 pontos e Configurações.</div>
   <div></strong>3 - Em "Privacidade e segurança", clique em <b>Configurações do site.</b></div>
   <div></strong>4 - Clique em Pop-ups e redirecionamentos.</b></div>
   <div></strong>5 - Em PERMITIR clique em ADICIONAR</div>
   <div></strong>6 - Coloque a url --> <B>meumenuzap.com</B>  e clique em ADICIONAR. PRONTO!</div>
