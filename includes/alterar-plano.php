				...
				<div id="sendnewpass" class="indent_title_in">
					...
					<form method="post">
						...
						<div class="form-group">							
							...
							<a class="btn btn-success" style="color:#ffffff;" target="_blank" href="https://api.whatsapp.com/send?phone=<?=$texto['telefoneAdministracaoVendas'];?>&text=Solicito%20o%20pagamento%20pelo%20pix%20ou%20boleto.%0A%0A*Loja:*%20<?=(!empty($nome_empresa) ? $nome_empresa : 'Nome_do_seu_negócio');?>%0A*Plano:*%20<?=$nplano;?>">
								Solicitar Pagamento Pelo Pix ou Boleto
							</a>
						</div>
					</form>
