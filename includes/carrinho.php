								...
								// Get all items in the cart
									...
									if ($type_pay == 0) {
									    ...
									    <div id="div_script_btn">
    									    ...
    									    <button id="btn_pay_mp" type="button" class="mercadopago-button" onclick="alert('Preencha os campos!');">Pagar Agora</button>
    									</div>
